...
public class NodeServiceTest {
	...
	public void testFindByParentId() throws Exception {
		final List<Node> searchResult = getNewTree().get(0).getChildren();
		when(repos.findByParentId(1L)).thenReturn(searchResult);
		final List<NodeDTO> dtoList = service.findByParentId(1L);
